defmodule ChanneledBeatsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ChanneledBeatsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ChanneledBeatsWeb.Gettext, "errors", msg, opts)
    end
  end
